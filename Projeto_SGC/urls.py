...
from App_SGC.views import CorrespondenciasListViews,CorrespondenciasCreateViews,CorrespondenciasUpdateViews,CorrespondenciasDeleteViews,CorrespondenciasEntregarViews
...
from App_SGC.views import PatrimonioListViews,PatrimonioCreateViews,PatrimonioUpdateViews,PatrimonioDeleteViews,PatrimonioBaixarViews
...
from App_SGC.views import FornecedoresListViews,FornecedoresCreateViews,FornecedoresUpdateViews,FornecedoresDeleteViews
from App_SGC.views import ContasReceberListViews,ContasReceberCreateViews,ContasReceberUpdateViews,ContasReceberDeleteViews, ContasReceberReceber
from App_SGC.views import ContasPagarListViews,ContasPagarCreateViews,ContasPagarUpdateViews,ContasPagarDeleteViews,ContasPagarPagar
...
from App_SGC.views import ProdutividadesListViews, ProdutividadesCreateViews,ProdutividadesUpdateViews,ProdutividadesDeleteViews


# Subsistema Metas
from App_SGC.views import MetasListViews, MetasCreateViews,MetasUpdateViews,MetasDeleteViews,MetasAvaliarViews


# Subsistema Enquete
from App_SGC.views import EnqueteCreateView, EnqueteDeleteView, EnqueteUpdateView, VotacaoView, VotacaoSubmitView, VotacaoRespostasView



from App_SGC.views import filtrar_unidades
...
#  Caminhos das Mudanças
    ...
    path('filtrar-unidades/', filtrar_unidades, name='filtrar_unidades'),
...
#  Caminhos de Correspondências
    ...
    path('correspondencias_entregar/<str:pk>', CorrespondenciasEntregarViews.as_view(template_name="correspondencias/correspondencias_entregar.html"), name="correspondencias_entregar"),
...
#  Caminhos do Patrimônio
    ...
    path('patrimonio_baixar/<str:pk>', PatrimonioBaixarViews.as_view(template_name="patrimonio/patrimonio_baixar.html"), name="patrimonio_baixar"),
...
#  Caminhos de Fornecedores
    path('fornecedores_list', FornecedoresListViews.as_view(template_name="fornecedores/fornecedores_list.html"), name="fornecedores_list"),
    path('fornecedores_create', FornecedoresCreateViews.as_view(template_name="fornecedores/fornecedores_create.html"), name="fornecedores_create"),
    path('fornecedores_update/<int:pk>/', FornecedoresUpdateViews.as_view(template_name="fornecedores/fornecedores_update.html"), name="fornecedores_update"),
    path('fornecedores_delete/<int:pk>', FornecedoresDeleteViews.as_view(template_name="fornecedores/fornecedores_confirm_delete.html"), name="fornecedores_delete"),
...
#  Caminhos das Contas a Receber
    ...
    path('contas_receber_receber/<int:pk>', ContasReceberReceber.as_view(template_name="contas_receber/contas_receber_receber.html"), name="contas_receber_receber"),
...
#  Caminhos das Contas a Pagar
    ...
    path('contas_pagar_pagar/<int:pk>/', ContasPagarPagar.as_view(template_name="contas_pagar/contas_pagar_pagar.html"), name="contas_pagar_pagar"),


#  Caminhos dos Relatórios Gerenciais
    path('previsao_realizado_list', PrevisaoxRealizadoListViews.as_view(template_name="relatorios_gerenciais/previsao_realizado_list.html"), name="previsao_realizado_list"),
    path('exec_orcamento_list', GraficosListViews.as_view(template_name="relatorios_gerenciais/exec_orcamento.html"), name="exec_orcamento_list"),




#  Caminhos SUBSISTEMA PRODUTIVIDADE ....................................................................


#  Caminhos da Produtividade
    path('produtividades_list', ProdutividadesListViews.as_view(template_name="produtividades/produtividades_list.html"), name="produtividades_list"),
    path('produtividades_create', ProdutividadesCreateViews.as_view(template_name="produtividades/produtividades_create.html"), name="produtividades_create"),
    path('produtividades_update/<int:pk>', ProdutividadesUpdateViews.as_view(template_name="produtividades/produtividades_update.html"), name="produtividades_update"),
    path('produtividades_delete/<int:pk>', ProdutividadesDeleteViews.as_view(template_name="produtividades/produtividades_confirm_delete.html"), name="produtividades_delete"),




#  Caminhos SUBSISTEMA METAS ....................................................................


#  Caminhos das Metas
    path('metas_list', MetasListViews.as_view(template_name="metas/metas_list.html"), name="metas_list"),
    path('metas_create', MetasCreateViews.as_view(template_name="metas/metas_create.html"), name="metas_create"),
    path('metas_update/<int:pk>', MetasUpdateViews.as_view(template_name="metas/metas_update.html"), name="metas_update"),
    path('metas_delete/<int:pk>', MetasDeleteViews.as_view(template_name="metas/metas_confirm_delete.html"), name="metas_delete"),
    path('metas_avaliar/<int:pk>', MetasAvaliarViews.as_view(template_name="metas/metas_avaliar.html"), name="metas_avaliar"),
   


#  Caminhos SUBSISTEMA ENQUETE ....................................................................
    path('enquete_create/', EnqueteCreateView.as_view(), name='enquete_create'),
    path('enquete_delete/', EnqueteDeleteView.as_view(), name='enquete_delete'),
    path('enquete_update/', EnqueteUpdateView.as_view(), name='enquete_update'),
    path('votacao/', VotacaoView.as_view(), name='votacao'),
    path('votacao/submit/', VotacaoSubmitView.as_view(), name='votacao_submit'),
    path('votacao/respostas/', VotacaoRespostasView.as_view(), name='votacao_respostas'),
