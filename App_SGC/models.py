...
class CustomConta_Receber(models.Model):
    ...
    valor_conta_receber = models.IntegerField(verbose_name="Valor a receber*", null=False, blank=False) 
    valor_conta_recebido = models.IntegerField(verbose_name="Valor recebido *", null=True, blank=True)     
